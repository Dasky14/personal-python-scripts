...
print("5* rate                  :", str(round((fiveStars / totalAttempts) * 100, 2)) + "%")
print("UP 5* rate               :", str(round((rateUpFiveStars / totalAttempts) * 100, 2)) + "%")
print("Average pulls per 5*     :", str(round(totalAttempts / fiveStars, 2)) + " pulls")
print("Average pulls per UP 5*  :", str(round(totalAttempts / rateUpFiveStars, 2)) + " pulls")
space()
print("Total 4*                 :", fourStars)
print("UP 4*                    :", rateUpFourStars)
print("4* rate                  :", str(round((fourStars / totalAttempts) * 100, 2)) + "%")
print("UP 4* rate               :", str(round((rateUpFourStars / totalAttempts) * 100, 2)) + "%")
print("Average pulls per 4*     :", str(round(totalAttempts / fourStars, 2)) + " pulls")
print("Average pulls per UP 4*  :", str(round(totalAttempts / rateUpFourStars, 2)) + " pulls")
space()
